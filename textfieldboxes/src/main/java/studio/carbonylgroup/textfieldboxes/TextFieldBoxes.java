...
public class TextFieldBoxes extends FrameLayout {
    ...
    protected void removeCounterError() {
        ...
        this.counterLabel.setTextColor(this.ctrTextColor);
    }
    ...
    private void triggerSetters() {
        ...
        setCtrTextColor(this.ctrTextColor);
    ...
    public void setCtrTextColor(int colorRes) {

        this.ctrTextColor = colorRes;
        this.counterLabel.setTextColor(this.ctrTextColor);
    }
    ...
    public int getCtrTextColor() {
        return this.ctrTextColor;
    }
